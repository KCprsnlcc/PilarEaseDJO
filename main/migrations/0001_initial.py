...
class Migration(migrations.Migration):
    ...
    operations = [
        ...
        migrations.AddField(
            model_name='reply',
            name='status',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='replies', to='main.status'),
        ),
        migrations.CreateModel(
            name='Referral',
            fields=[
        ...
        migrations.AddField(
            ...
            name='replied_by',
            field=models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='reply_notifications', to=settings.AUTH_USER_MODEL),
        ),
