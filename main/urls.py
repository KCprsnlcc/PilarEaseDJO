...
from .views import register_view, login_view, logout_view, contact_us_view, get_status, refer_status, save_questionnaire_data
...
urlpatterns = [
    ...
    path('save_questionnaire_data/', save_questionnaire_data, name='save_questionnaire_data'),
